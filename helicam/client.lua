...
Citizen.CreateThread(function()
	while true do
		...
		if isInAuthorisedVehicle() and target_vehicle and not helicam and vehicle_display ~=2 then
...
function isInAuthorisedVehicle()
	local lPed = GetPlayerPed(-1)
    local vehicle = GetVehiclePedIsIn(lPed)
    for k,v in pairs(AuthorisedHelicopters) do
