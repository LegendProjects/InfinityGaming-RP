Locales['en'] = {
  ...
  ['work_wear'] = 'Vanilla Unicorn Uniform',
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['vanillaunicorn_stock'] = 'Vanilla Unicorn Stock',
  -- Misc
  ['map_blip'] = 'Vanilla Unicorn',
  -- Notifications
  ['alert_vanillaunicorn'] = 'Vanilla Unicorn Alert',
  ['phone_vanillaunicorn'] = 'Vanilla Unicorn',
