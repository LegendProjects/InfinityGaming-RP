Locales['en'] = {
  ...
  ['work_wear'] = 'Pulse Lottery Uniform',
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['pulselottery_stock'] = 'Pulse Lottery Stock',
  -- Misc
  ['map_blip'] = 'Pulse Lottery',
  -- Notifications
  ['alert_pulselottery'] = 'Pulse Lottery Alert',
  ['phone_pulselottery'] = 'Pulse Lottery',
}
