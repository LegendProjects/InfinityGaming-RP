Locales['en'] = {
  ...
  ['rent_vehicle']            = 'PDM - Vehicles for rent',
  ['return_provider_menu']    = 'PDM - Return vehicle to provider',
  ...
  ['inventory']               = 'inventory',
  ['dealership']              = 'Premium Deluxe Motors',
  ['amg_customers']            = 'PDM Customers',
