Locales['en'] = {
	...
	['must_wait'] = 'You must Wait %s Minutes before Accessing Impound Again!',
	...
	['car_is_impounded'] = 'Vehicle unavailable, check the impound.',
	['car_is_striked'] = 'Vehicle unavailable, vehicle has been striked.',
	['garage_has_notstored'] = 'There are no vehicles to store.',
}