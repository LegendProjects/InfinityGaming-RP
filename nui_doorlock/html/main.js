    ...
    window.addEventListener("message", function (event) {
        ...
        else
        {
            if (event.data.text == "Locked") {
                ...
                event.data.text = '<i style="color:orange;" class="fas fa-lock"><span style="font-family:\'Whitney-Medium\', sans-serif; font-style: normal; font-size:14px;"><br>Locking...</span></i>'
            }
