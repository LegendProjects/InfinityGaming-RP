Locales['en'] = {
  ...
  ['paid_rental']             = 'you have ~g~payed for your vehicle rental: ~g~$%s',
  ['pop_vehicle']             = 'put out vehicle for sale',
  ['rent_vehicle']            = 'Luxury Autos - Vehicles for rent',
  ['return_provider_menu']    = 'Luxury Autos - Return vehicle to provider',
  ...
  ['generic_shopitem']        = '$%s',
  ['vehicle_dealer']          = 'vehicle - Luxury Autos',
  ...
  ['inventory']               = 'inventory',
  ['dealership']              = 'Luxury Autos',
  ['amg_customers']            = 'Luxury Autos Customers',
