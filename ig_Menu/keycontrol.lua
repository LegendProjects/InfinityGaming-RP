...
RegisterNetEvent('igMenu:closeAllSubMenu')
AddEventHandler('igMenu:closeAllSubMenu', function()
	TriggerEvent('igMenu:closeMenuAmbulance')
	TriggerEvent('igMenu:closeMenuPolice')
	TriggerEvent('igMenu:closeMenuMecano')
	TriggerEvent('igMenu:closeMenuInventaire')
	TriggerEvent('igMenu:closeMenuPersonnel')
end)

RegisterNetEvent('igMenu:closeAllMenu')
AddEventHandler('igMenu:closeAllMenu', function()
...
--------------------------------------------------------------------------------------------
-- Menu Perso
RegisterNetEvent('igMenu:closeMenuPersonnel')
AddEventHandler('igMenu:closeMenuPersonnel', function()
...
-- Inventaire
RegisterNetEvent('igMenu:closeMenuInventaire')
AddEventHandler('igMenu:closeMenuInventaire', function()
...
-- Telephone
RegisterNetEvent('igMenu:closeMenuTelephone')
AddEventHandler('igMenu:closeMenuTelephone', function()
	TriggerEvent('igMenu:closeAllMenu')
end)

-- Factures
RegisterNetEvent('igMenu:closeMenuFactures')
AddEventHandler('igMenu:closeMenuFactures', function()
	TriggerEvent('igMenu:closeAllMenu')
end)
