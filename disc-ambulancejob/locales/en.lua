Locales['en'] = {
  ...
  ['long_wear'] = 'EMS Long Sleeve Uniform',
  ['short_wear'] = 'EMS Short Sleeve Uniform',
  ['bike_wear'] = 'EMS Bike Uniform',
  ['pilot_wear'] = 'EMS Pilot Uniform',
  -- Vehicles
  ['ambulance'] = 'ambulance',
  ...
  ['ems_menu_escort'] = 'Escort The Patient',
  ['ems_menu_putincar'] = 'Put Patient in Vehicle',
  ['ems_menu_pull'] = 'Pull patient out of vehicle',
  ['ems_menu_small'] = 'Heal small wounds',
  ['ems_menu_big'] = 'Treat serious injuries',
  -- Phone
  ['alert_ambulance'] = 'alert Ambulance',
  -- Death
  ['respawn_available_in'] = 'Early respawn available in %s minutes %s seconds',
  ['respawn_bleedout_in'] = 'you will bleed out in %s minutes %s seconds\n',
  ['respawn_bleedout_prompt'] = 'hold [~b~E~w~] to respawn',
  ['respawn_bleedout_fine'] = 'hold [~b~E~w~] to respawn for ~g~$%s',
