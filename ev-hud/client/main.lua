...
RegisterNetEvent('ev-hud:client:updateStatus')
AddEventHandler('ev-hud:client:updateStatus', function(data)
    local hungerVal, thirstVal, drunkVal
    for k,v in pairs(data) do
        if v.name == 'hunger' then 
            hunger = v.percent
            -- print('Hunger: ' .. v.percent)
        elseif v.name == 'thirst' then 
            thirst = v.percent
            -- print('Thirst: ' .. v.percent)
        elseif v.name == 'drunk' then 
            drunk = v.percent
            -- print('Drunk: ' .. v.percent)
        end
    end
...
-- Citizen.CreateThread(function()
-- 	while true do
-- 		TriggerEvent('iG_Status:getStatus', 'hunger', function(h)
--             TriggerEvent('iG_Status:getStatus', 'thirst', function(t)
--                 TriggerEvent('iG_Status:getStatus', 'drunk', function(d)
--                     hunger = h.getPercent()
--                     thirst = t.getPercent()
--                     drunk = d.getPercent()
-- 				end)
