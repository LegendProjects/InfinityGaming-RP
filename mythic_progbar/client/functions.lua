        ...
        if not isDoingAction then
            ...
            Citizen.CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if (IsControlJustPressed(0, 73) or IsControlJustPressed(0, 178)) and mythic_action.canCancel then
...
function ActionCleanup()
    ...
    while DoesEntityExist(NetToObj(prop_net)) do
        DetachEntity(NetToObj(prop_net), 1, 1)
        DeleteEntity(NetToObj(prop_net))
        Citizen.Wait(0)
    end

    while DoesEntityExist(NetToObj(propTwo_net)) do
