...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
-- 						MECHANIC ZONES / MODIFICATION AREAS
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
Config.Mechanics = {
	...
	Shared = {
		Job_Auth = 'shared',
		ModAreas = {
			vector3(1724.32, 3300.2, 41.28),
			vector3(1722.44, 3306.88, 41.28),
			vector3(1720.92, 3313.32, 41.28),
			vector3(1739.24, 3317.08, 41.28),
			vector3(1741.04, 3310.28, 41.28),
			vector3(1742.68, 3303.84, 41.28),
			vector3(-1417.12, -446.32, 35.21),
			vector3(-1423.34, -450.49, 35.21),
			vector3(-1411.28, -442.54, 35.21),
		}
	},
	...
	Solntservo = {
		Job_Auth = 'sar',
		ModAreas = {
			vector3(727.47, -1067.66, 21.47),
			vector3(735.45, -1067.8, 21.47),
			vector3(734.57, -1088.81, 21.47),
			vector3(717.79, -1088.85, 21.47),
			vector3(752.01, -1080.2, 33.12)
		}
	},
	...
	DragonsJDM = {
		Job_Auth = 'dragonsjdm',
		ModAreas = {
			vector3(-222.76, -1329.52, 30.88),
			vector3(-213.12, -1328.8, 30.88),
			vector3(-212.16, -1319.4, 30.88),
			vector3(-206.56, -1321.52, 30.88),
			vector3(-205.56, -1306.68, 31.32)
		}
	},
	...
	SinsGarage = {
		Job_Auth = 'sinsgarage',
		ModAreas = {
			vector3(1182.32, 2650.68, 37.84),
			vector3(1174.6, 2649.56, 37.8),
			vector3(1175.08, 2639.64, 37.76),
			vector3(1182.72, 2638.2, 37.8),
			vector3(1175.67, 2664.61, 39.71)
		}
	},
	...
	Beekers = {
		Job_Auth = 'beekers',
		ModAreas = {
			vector3(115.28, 6611.68, 31.88),
			vector3(120.52, 6617.0, 31.84),
			vector3(110.48, 6626.4, 31.8),
			vector3(103.88, 6622.48, 31.84)
		}
	}
}
...
function GetHeadlights()
	local headlights = {
		{label = 'Navy blue', index = 1 },
		{label = 'Light blue', index = 2 },
		{label = 'Turquoise', index = 3 },
		{label = 'Green', index = 4 },
		...
		{label = 'Red', index = 8 },
		{label = 'Pink', index = 9 },
		{label = 'Violet', index = 10 },
		{label = 'Purple', index = 11 },
		{label = 'Ultraviolet', index = 12 }
	}
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {0.5, 0.75, 1, 1.5}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {0.5, 0.75, 1, 1.25}
	},
	modTransmission = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {0.5, 0.75, 0.5, 0.75,1}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {0.5, 1.5, 2, 3, 4, 5}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	cosmetics = {
		...
		otherbodyparts		= 'Unique Body Parts',
