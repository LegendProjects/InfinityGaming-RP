...
window.addEventListener("message", function (event) {
    ...
    //    $("#noSecondInventoryMessage").html(invLocale.secondInventoryNotAvailable);
        ...
        $.post("https://ig-inventory/GiveItem", JSON.stringify({
            player: player,
...
function closeInventory() {
    $(".ui").fadeOut();
    $.post("https://ig-inventory/NUIFocusOff", JSON.stringify({}));
	...
	$('#itemFast-1').droppable({
        drop: function (event, ui) {
            ...
            if (type === "normal" && (itemInventory === "main" || itemInventory === "fast")) {
                $.post("https://ig-inventory/PutIntoFast", JSON.stringify({
                    item: itemData,
                    slot : 1,
                }));
            }
...
$(document).ready(function () {
        ...
        if (type === "normal" && itemInventory === "main" && itemData.usable) {
            if (itemData.name.includes("WEAPON_")) {
                if (itemInventory === "fast") 
                {
                    ...
                    $.post("https://ig-inventory/TakeFromFast", JSON.stringify({
                        item: itemData
                    }));
                }
                
            } else {
                $.post("https://ig-inventory/UseItem", JSON.stringify({
                    item: itemData
                }));
                closeInventory();
            }
    ...
    $(document).on('contextmenu', '.item', function (e) {
        ...
        if(e.shiftKey) {
            if (itemInventory === "second") {
                if (type === "trunk") {
                    $.post("https://ig-inventory/TakeFromTrunk", JSON.stringify({
    
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "property") {
                    $.post("https://ig-inventory/TakeFromProperty", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val()),
                        owner : ownerHouse
                    }));
                } else if (type === "vault") {
                    $.post("https://ig-inventory/TakeFromVault", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "locker") {
                    $.post("https://ig-inventory/TakeFromLocker", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "player") {
                    $.post("https://ig-inventory/TakeFromPlayer", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                    ...
                    $.post("https://ig-inventory/TakeFromShop", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
    
                } else if (type === "motels") {
                    $.post("https://ig-inventory/TakeFromMotel", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
    
                } else if (type === "motelsbed") {
                    $.post("https://ig-inventory/TakeFromMotelBed", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "glovebox") {
                    $.post("https://ig-inventory/TakeFromGlovebox", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "bag") {
                    $.post("https://ig-inventory/TakeFromBag", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "evidence") {
                    $.post("https://ig-inventory/TakeFromEvidence", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));

                } else if (type === "storage") {
                    $.post("https://ig-inventory/TakeFromStorage", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));

                } else if (type === "businessstorage") {
                    $.post("https://ig-inventory/TakeFromBusinessStorage", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                }
                ...
                if (type === "trunk") {
                    $.post("https://ig-inventory/PutIntoTrunk", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "property") {
                    $.post("https://ig-inventory/PutIntoProperty", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val()),
                        owner : ownerHouse
                    }));
                } else if (type === "vault") {
                    $.post("https://ig-inventory/PutIntoVault", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "locker") {
                    $.post("https://ig-inventory/PutIntoLocker", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "player") {
                    $.post("https://ig-inventory/PutIntoPlayer", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "motels") {
                    $.post("https://ig-inventory/PutIntoMotel", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }))
                } else if (type === "motelsbed") {
                    $.post("https://ig-inventory/PutIntoMotelBed", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "glovebox") {
                    $.post("https://ig-inventory/PutIntoGlovebox", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "bag") {
                    $.post("https://ig-inventory/PutIntoBag", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "evidence") {
                    $.post("https://ig-inventory/PutIntoEvidence", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "storage") {
                    $.post("https://ig-inventory/PutIntoStorage", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                } else if (type === "businessstorage") {
                    $.post("https://ig-inventory/PutIntoBusinessStorage", JSON.stringify({
                        item: itemData,
                        number: parseInt($("#count").val())
                    }));
                }
    ...
    $('#drop').droppable({
        ...
        drop: function (event, ui) {
            ...
            $.post("https://ig-inventory/DropItem", JSON.stringify({
    ...
    $('#playerInventory').droppable({
        drop: function (event, ui) {
            ...
            } else if (type === "businessstorage" && itemInventory === "second") {
                $.post("https://ig-inventory/TakeFromBusinessStorage", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
    ...
    $('#otherInventory').droppable({
        drop: function (event, ui) {
            ...
            } else if (type === "businessstorage" && itemInventory === "main") {
                $.post("https://ig-inventory/PutIntoBusinessStorage", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
