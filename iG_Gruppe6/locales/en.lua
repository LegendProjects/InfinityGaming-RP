Locales['en'] = {
  ...
  ['open_cloakroom'] = 'press ~INPUT_CONTEXT~ to change clothes.',
  -- Armory
  ...
  ['being_searched'] = 'you are being searched by Gruppe6',
  -- Vehicle interaction
