...
ss_weather_Transition = {
	["EXTRASUNNY"] = {"CLEAR", "CLEARING"},
	["SMOG"]       = {"CLEAR","CLEARING","CLOUDS","EXTRASUNNY"},
	["CLEAR"]      = {"CLOUDS","EXTRASUNNY","CLEARING", "OVERCAST"},
	["CLOUDS"]     = {"EXTRASUNNY","CLEAR","SMOG","CLEARING","OVERCAST"},
	["OVERCAST"]   = {"EXTRASUNNY","CLEAR","CLOUDS","SMOG","CLEARING","THUNDER"},
