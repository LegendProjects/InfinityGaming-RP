...
-- Teleportation
Config.Goto = 'TrialMod'
Config.Return = 'TrialMod'
Config.Bring = 'TrialMod'
Config.Teleport = 'TrialMod'

-- Admin Commands
Config.Revive = 'Moderator'
Config.Defib = 'TrialMod'
Config.Heal = 'TrialMod'
Config.Feed = 'Moderator'
Config.Slay = 'TrialMod'
Config.Slap = 'Moderator'
Config.Freeze = 'TrialMod'
Config.Unfreeze = 'TrialMod'
Config.Crash = 'Admin'
Config.Whois = 'SeniorMod'
Config.Cuff = 'TrialMod'
Config.Uncuff = 'TrialMod'
Config.AV = 'TrialMod'
Config.AdminRepair = 'SeniorMod'
Config.AdminModMenu = 'ServerManager'

-- Announcements
Config.Announcement = 'Admin'
Config.StaffAnnouncement = 'Moderator'

Config.locale = 'en'

Config.webhookurl       = 'https://discordapp.com/api/webhooks/644123139290431548/vouLg5n3Uh7DZ6GKsIUANa5QHtwOr-f7FwJ8-Qu_RBSUIGthq7UgwNrT7tGGASn-tE53'
...
Config.Uniforms = { 
    admin_vest = {
        ...
        female = {
            ['bproof_1'] = 27,  ['bproof_2'] = 4
        }
    },
}


Config.pedThreshold = 150
