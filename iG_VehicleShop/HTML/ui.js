function CloseShop() {
    $("#wrapper").html('');
	$("#shopmenu").hide();
    $.post('http://iG_VehicleShop/CloseMenu');
}
...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Price: $<b>`+ Math.ceil(car.price + (car.price*0.40))+`</b></p>
                                    </div>
    ...
    $("#body").on('click', ':button', function () {
        ...
        if($(this).data('value') == "buy")
            $.post('http://iG_VehicleShop/BuyVehicle', JSON.stringify({model: $(this).data('model')}));
        else if($(this).data('value') == "test-drive")
            $.post('http://iG_VehicleShop/TestDrive', JSON.stringify({model: $(this).data('model')}));
    });
