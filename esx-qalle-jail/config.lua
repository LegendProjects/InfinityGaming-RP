...
Config.JailPositions = {
	["Cell"] = { ["x"] = 1771.0, ["y"] = 2479.76, ["z"] = 45.76, ["h"] = 26.0 }
}

Config.Cutscene = {
	["PhotoPosition"] = { ["x"] = 480.95, ["y"] = -985.96, ["z"] = 24.27, ["h"] = 180.55 },

	["CameraPos"] = { ["x"] = 481.98, ["y"] = -989.61, ["z"] = 25.1, ["rotationX"] = 1.433070763946, ["rotationY"] = 0.0, ["rotationZ"] = 15.31496068835258, ["cameraId"] = 0 },

	["PolicePosition"] = { ["x"] = 480.81, ["y"] = -988.64, ["z"] = 24.27, ["h"] = 358.48 }
}
