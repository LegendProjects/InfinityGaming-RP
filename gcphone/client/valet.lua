...
RegisterNUICallback('getCars', function(data)
    ESX.TriggerServerCallback('iG_Phone:getCars', function(data)
        for i = 1, #data do
...
RegisterNUICallback('getCarsValet', function(data)
    ...
    TriggerServerEvent("iG_Phone:valet-car-set-outside", data.props.plate)
...
function GoToTargetWalking(x, y, z, vehicle, driver)
    ...
    TriggerServerEvent('iG_Phone:finish')
    Citizen.Wait(35000)
    DeletePed(mechPed)
    mechPed = nil
end