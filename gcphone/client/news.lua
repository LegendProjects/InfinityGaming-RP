...
Citizen.CreateThread(function()
    ...
    AddTextComponentSubstringPlayerName("Entertainment: 7 News")
        ...
        if PlayerData.job and PlayerData.job.name == Config.newsJobName then 
            ...
            if distance < 5.0 then
                ...
                if distance < 2.0 then
                    DrawText3D(newsMenu.x, newsMenu.y, newsMenu.z+0.60, "[E] 7 News", 0.45)
                    if IsControlJustPressed(1, 38) then
                        ...
                        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'news_menu',
                        {
                            ...
                            elseif data.current.value == "boss" then
                                TriggerEvent('iG_society:openBossMenu', 'news', function(data, menu)
                                    menu.close()
