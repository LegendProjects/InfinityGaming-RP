Locales['en'] = {
  ...
  ['police_wear'] = 'General Duties Uniform',
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the armoury.',
  ['open_itemstore'] = 'press ~INPUT_CONTEXT~ to withdraw equipment.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ...
  ['watercraft_prompt'] = 'press ~INPUT_CONTEXT~ to access the Watercraft Actions.',
  ['watercraft_notauthorized'] = 'you\'re not authorized to buy watercraft.',
  ['shop_item'] = '$%s',
  ...
  ['jail'] = 'Jail',
  -- Evidence locker
  ['open_evidence_locker'] = 'Press ~INPUT_CONTEXT~ to access the Evidence locker.',
}
